/* ---- Script to produce populations by different protected characteristics (age, gender and ethnicity) and geographies 
(National, ICB and Sub-ICB) using the 2021 census data. Used to produce rates of open referrals per 100,000 population values -- */
...
FROM [UKHF_Census].[Age_By_Single_Year_Of_Age_V21] a
	...
	LEFT JOIN [Reporting_UKHD_ODS].[Commissioner_Hierarchies] r ON l.[ODS_SubICB_Code22] = r.[Organisation_Code]
